...
fn pxlate(img: DynamicImage, sfactor: usize, palette_choice: String) -> DynamicImage {
    ...
    color_palette.insert(
        ...
        vec![
            ...
            Rgba([202, 183, 174, 255]),
            Rgba([216, 190, 204, 255]),
            Rgba([186, 133, 157, 255]),
            Rgba([148, 112, 120, 255]),
            Rgba([234, 211, 206, 255]),
            Rgba([224, 187, 228, 255]),
            Rgba([197, 163, 185, 255]),
            Rgba([181, 139, 132, 255]),
            Rgba([251, 221, 201, 255]),
            Rgba([174, 146, 138, 255]),
            Rgba([220, 194, 158, 255]),
        ],
    );

    color_palette.insert(
        "rainbowdash".to_string(),
        vec![
